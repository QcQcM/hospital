<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doctorOperation.aspx.cs" Inherits="doctorOperation" %>
                                ...
                                <div class="table-responsive">
                                    <table class="table-responsive" style ="width:900px;height:400px" cellpadding="0">
                                            <tr class="bg-info text-white">
                                              ...
                                              <td class="table-bordered td text-center "><strong>手术编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>手术名称</strong></td>
                                              <td class="table-bordered td text-center "><strong>医生编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>订单编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>时间</strong></td>
                                           </tr>
                                          <tr>
