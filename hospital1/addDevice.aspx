<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addDevice.aspx.cs" Inherits="addDevice" %>
<!DOCTYPE html>
    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <div class="sidebar-header d-flex align-items-center">
                ...
                <asp:ImageButton runat="server" CausesValidation = "false" ID="sign_up" style="background-image:url(./img/logout/zhuxiao.png);margin-left:20px;margin-bottom:7px" OnClick="sign_up_Click" />
            </div>
