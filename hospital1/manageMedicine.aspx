<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manageMedicine.aspx.cs" Inherits="manageMedicine" %>
                                ...
                                <div class="table-responsive">
                                    <table class="table-responsive" style ="width:900px;height:80px" cellpadding="0">
                                            <tr class="bg-info text-white">
                                              ...
                                              <td class="table-bordered td text-center "><strong>厂家编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>价格</strong></td>
                                              <td class="table-bordered td text-center "><strong>库存数量</strong></td>
                                              <td class="table-bordered td text-center "><strong>适应症</strong></td>
                                           </tr>
                                           <tr>
                                              <td><asp:TextBox ID="drug_num" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                              <td><asp:TextBox ID="drug_name" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                              <td><asp:TextBox ID="manufacter" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                               <td><asp:TextBox ID="price" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                               <td><asp:TextBox ID="amount" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                               <td><asp:TextBox ID="type" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                           </tr>
                                    ...
                                    <div style="margin-bottom:3cm;margin-left:350px">
                                        ...
                                        <asp:Button ID="update_drug" runat="server" Text="修改"  class="btn btn-general btn-blue mr-3" OnClick="update_drug_Click"/> 
                                        <asp:Button ID="delete_drug" runat="server" Text="删除"  class="btn btn-general btn-blue mr-3" OnClick="delete_drug_Click"/> 
