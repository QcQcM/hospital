<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leaveHospital.aspx.cs" Inherits="leaveHospital" %>
    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner chart-cont">
            ...
            <div class="card p-4">
                    ...
                    <div>
                       <input ID="patientId"  runat="server" class="form-control" style="width:500px;height:30px" />
                     </div>
                     <div>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:Button runat="server" class="btn btn-primary btn-sm" text="搜索" ID="Button2" OnClick="Button2_Click" ></asp:button>                                    
                     </div>
                     <div>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="row">   
                    ...
                    <section class="col-xs-12 col-sm-6 col-md-12" style="margin-bottom:30px">                       
                        <article class="search-result row">
                            <div  class="col-xs-6 col-sm-6 col-md-3">
                                   <asp:label runat="server"  id="Label1"  style="color:#005FC6;font-size:large"   Visible="false">姓名</asp:label>
                                <asp:label runat="server" font-size="Medium" ID="Name" ></asp:label>
                            </div>
                            <div  class="col-xs-6 col-sm-6 col-md-3">
                                  <asp:label runat="server"  id="Label2"  style="color:#005FC6;font-size:large"   Visible="false">患者编号</asp:label>
                                <asp:label runat="server" font-size="Medium" id="Id"></asp:label> 
                            </div>
                             <div  class="col-xs-6 col-sm-6 col-md-3">
                                   <asp:label runat="server"  id="Label3"  style="color:#005FC6;font-size:large"   Visible="false">性别</asp:label>
                                <asp:label runat="server" font-size="Medium" id="Sex"></asp:label> </div>                         
                            <div  class="col-xs-6 col-sm-6 col-md-3">
                                   <asp:label runat="server"  id="Label4"  style="color:#005FC6;font-size:large"   Visible="false">年龄</asp:label>
                                <asp:label runat="server" font-size="Medium" id="Age"></asp:label> 
                            </div>
                            </article>
                           </section>
                            ...
                            <br />
                             <section  class="col-xs-12 col-sm-6 col-md-12" style="margin-bottom:30px">
                                 <article class="search-result row">
                             <div  class="col-xs-6 col-sm-6 col-md-3">
                                   <asp:label runat="server"  id="Label5"  style="color:#005FC6;font-size:large"   Visible="false">电话</asp:label>
                                <asp:label runat="server" font-size="Medium" id="Tel"></asp:label> </div> 
                             <div  class="col-xs-6 col-sm-6 col-md-3">
                                <asp:label runat="server"  id="Label6"  style="color:#005FC6;font-size:large"   Visible="false">入诊科室</asp:label>
                                <asp:label runat="server" font-size="Medium" id="Department"></asp:label> 
                            </div>
                         </article>          
                     </section>
                    ...
                    <section class="col-xs-12 col-sm-6 col-md-12">                       
                        <article class="search-result row">
                            <div  class="col-xs-6 col-sm-6 col-md-3">
                                <asp:label runat="server"  id="admissionDay1"  style="color:#005FC6;font-size:large"   Visible="false">入院日期</asp:label>
                                <asp:label runat="server"  font-size="Medium" ID="admissionDay" Visible="false"></asp:label>
                            </div>
                            <div  class="col-xs-6 col-sm-6 col-md-3">
                                <asp:label runat="server"  id="dischargeDay1"  style="color:#005FC6;font-size:large"  Visible="false" >出院日期</asp:label> 
                                <asp:label runat="server" font-size="Medium" id="dischargeDay" Visible="false"></asp:label> 
                            </div>
                            <div  class="col-xs-6 col-sm-6 col-md-3">
                                <asp:label runat="server"  id="lengthStay1"  style="color:#005FC6;font-size:large"   Visible="false">入院时长</asp:label>                       
                                <asp:label runat="server" font-size="Medium" id="lengthStay" Visible="false"></asp:label> 
                            </div>                           
                         </article>          
                     </section> 
                    <br />
                     ...
                     <section class="col-xs-12 col-sm-6 col-md-12">
                        ...
                        <article class="search-result row">
                            <div  class="col-xs-6 col-sm-6 col-md-6">
                                <asp:label runat="server"  id="diagnose1"  style="color:#005FC6;font-size:large"   Visible="false">入院诊断</asp:label>  
                                   <asp:label runat="server" font-size="Medium" id="diagnose" Visible="false"></asp:label> 
                            </div>                           
                         </article> 
                         <br /><br /><br /><br />          
                     </section>
                    ...
                    <section class="col-xs-12 col-sm-6 col-md-12">
                        <br />                       
                        <article class="search-result row">
                           <asp:Table ID="Table1" runat="server" CssClass="table borderless"  Visible="false" >
                               <asp:TableHeaderRow  CssClass="bg-info text-white">
                                   <asp:TableHeaderCell>订单编号</asp:TableHeaderCell>
                                   <asp:TableHeaderCell>医生编号</asp:TableHeaderCell>        
                                   <asp:TableHeaderCell>数量</asp:TableHeaderCell>
                                   <asp:TableHeaderCell>订单类型</asp:TableHeaderCell>
                                     <asp:TableHeaderCell>订单时间</asp:TableHeaderCell>
                                     <asp:TableHeaderCell>手术或检查的时间</asp:TableHeaderCell>
                                     <asp:TableHeaderCell>订单使用的药品或仪器</asp:TableHeaderCell>
                    ...
                    <section class="col-xs-12 col-sm-6 col-md-12">
                        <br />                       
                        <article class="search-result row">
                           <asp:Table ID="doctorAdvices" runat="server" CssClass="table borderless"  Visible="false">
                               <asp:TableHeaderRow  CssClass="bg-info text-white">
                                   <asp:TableHeaderCell>医生编号</asp:TableHeaderCell>
                                   <asp:TableHeaderCell>患者编号</asp:TableHeaderCell>
                                   <asp:TableHeaderCell>时间</asp:TableHeaderCell>
                                   <asp:TableHeaderCell>医嘱内容</asp:TableHeaderCell>
                                     <asp:TableHeaderCell>医嘱类型</asp:TableHeaderCell>
                                     <asp:TableHeaderCell>医生姓名</asp:TableHeaderCell>
                               </asp:TableHeaderRow>
                           </asp:Table>
                         </article>
                        <br /><br /><br /><br />          
                    ...
                    <section class="col-xs-12 col-sm-6 col-md-12">
                     ...
                     <section class="col-xs-12 col-sm-6 col-md-12">
                        ...
                        <article class="search-result row">
                            <div  class="col-xs-6 col-sm-6 col-md-6">
                                <h5><a href="#" title="">总价</a></h5>
                                   <asp:label runat="server" font-size="Medium" id="totalprice">王壮壮</asp:label> 
                            </div>                           
                         </article>
                        <br /><br /><br /><br />          
                     </section>                      
