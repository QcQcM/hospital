<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateDepartment.aspx.cs" Inherits="Views_updateDepartment" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" >
                            ...
                            <div class="panel-body" >
                                    ...
                                    <label>编号</label>
                                    <asp:Textbox id="Department_num" runat="server"></asp:Textbox>
                                     
                                    <asp:Button ID="Search_Department" runat="server" Text="搜索 " class="btn btn-link" OnClick="Search_Department_Click"/> 
                             </div>
                                <div class="table-responsive">
                                    <table class="table-responsive" style ="width:900px;height:80px" cellpadding="0">
                                            <tr class="bg-info text-white">
                                              <td class="table-bordered td text-center "><strong>科室编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>科室名</strong></td>
                                              <td class="table-bordered td text-center "><strong>负责人</strong></td>
                                           </tr>
                                           <tr>
                                              <td><asp:TextBox ID="department_num1" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                              <td><asp:TextBox ID="department_name" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                              <td><asp:TextBox ID="department_user" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                           </tr>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <asp:Button ID="add_department" runat="server" Text="修改"  class="btn btn-general btn-blue mr-3" OnClick="add_department_Click"/> 
                                        <asp:Button ID="delete_department" runat="server" Text="删除"  class="btn btn-general btn-blue mr-3" OnClick="delete_department_Click"/> 
