<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateRoom.aspx.cs" Inherits="Views_updateRoom" %>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" >
                            ...
                            <div class="panel-body" >
                                    ...
                                    <label>编号</label>
                                    <asp:Textbox id="search_num" runat="server"></asp:Textbox>
                                    <asp:Button ID="search_room" runat="server" Text="搜索 " class="btn btn-link" OnClick="search_room_Click"/> 
                             </div>
                                <div class="table-responsive">
                                    <table class="table-responsive" style ="width:900px;height:80px" cellpadding="0">
                                            <tr class="bg-info text-white">
                                              <td class="table-bordered td text-center "><strong>病房编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>病房位置</strong></td>
                                              <td class="table-bordered td text-center "><strong>所属科室</strong></td>
                                           </tr>
                                           <tr>
                                              <td><asp:TextBox ID="room_num" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                              <td><asp:TextBox ID="room_location" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                              <td><asp:TextBox ID="room_department" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%" readonly="true"></asp:TextBox></td>
                                           </tr>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <asp:Button ID="add_room" runat="server" Text="修改"  class="btn btn-general btn-blue mr-3" OnClick="add_room_Click"/> 
                                        <asp:Button ID="delete_room" runat="server" Text="删除"  class="btn btn-general btn-blue mr-3" OnClick="delete_room_Click"/> 
