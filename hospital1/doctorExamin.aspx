    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            <div class="sidebar-header d-flex align-items-center">
                ...
                <asp:ImageButton runat="server" ID="sign_up" style="background-image:url('img/logout/zhuxiao.png'); margin-left:20px;margin-bottom:7px; width: 14px; height: 16px;" OnClick="sign_up_Click" />
            </div>
            <hr>
