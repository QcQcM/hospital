<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doctorExamin.aspx.cs" Inherits="doctorExamin" %>
...
======================================================-->
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            <div class="sidebar-header d-flex align-items-center">
                ...
                <asp:ImageButton CausesValidation = "false" runat="server" ID="sign_up" style="background-image:url('img/logout/zhuxiao.png'); margin-left:20px;margin-bottom:7px; width: 14px; height: 16px;" OnClick="sign_up_Click" />
            </div>
            <hr>
                                ...
                                <div class="table-responsive">
                                    <table class="table-responsive" style ="width:900px;height:400px" cellpadding="0">
                                            <tr class="bg-info text-white">
                                              ...
                                              <td class="table-bordered td text-center "><strong>检查仪器编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>检查名称</strong></td>
                                              <td class="table-bordered td text-center "><strong>医生编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>订单编号</strong></td>
                                              <td class="table-bordered td text-center "><strong>检查时间</strong></td>
                                           </tr>
                                          <tr>
                                              ...
                                              <td><asp:TextBox ID="examination1" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
                                               <td><asp:TextBox ID="doctor1" ReadOnly="true" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
                                            ...
                                            <tr>
                                              ...
                                              <td><asp:TextBox ID="examination2" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
                                               <td><asp:TextBox ID="doctor2" ReadOnly="true" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
  ...
  <tr>
                                              ...
                                              <td><asp:TextBox ID="examination3" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
                                               <td><asp:TextBox ID="doctor3" ReadOnly="true" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
  ...
  <tr>
                                              ...
                                              <td><asp:TextBox ID="examination4" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
                                               <td><asp:TextBox ID="doctor4" ReadOnly="true" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
  ...
  <tr>
                                              ...
                                              <td><asp:TextBox ID="examination5" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
                                               <td><asp:TextBox ID="doctor5" ReadOnly="true" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
  ...
  <tr>
                                              ...
                                              <td><asp:TextBox ID="examination6" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
                                               <td><asp:TextBox ID="doctor6" ReadOnly="true" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
  ...
  <tr>
                                              ...
                                              <td><asp:TextBox ID="examination7" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
                                               <td><asp:TextBox ID="doctor7" ReadOnly="true" runat="server" class="table-bordered td text-center" Width ="100%" Height ="100%"></asp:TextBox></td>
